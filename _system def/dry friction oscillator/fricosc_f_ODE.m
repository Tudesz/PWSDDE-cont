function X = fricosc_f_ODE(x,xd,p,mode,type,l)
%FRICOSC_F_ODE Vector field definitions for an example dry friction 
% oscillator problem in an ODE form for validation
...
switch mode
    ...
    case 1 
        switch type
            ...
            case 3
                X = [zeros(1,5);
                    -2*x(2), p(4)*sin(x(3)-p(2)*p(3)), ...
                    p(4)*sin(x(3)-p(2)*p(3)), cos(x(3)-p(2)*p(3)), 0;
                    0, 1, 0, 0, 0];
        end
