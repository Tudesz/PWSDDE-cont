function X = e_fricosc_ODE(x,xd,p,id,type,l)
%E_FRICOSC_ODE Event definitions for an example dry friction oscillator problem
...
switch id
    ...
    case 4
        switch type
            ...
            % Parameter Jacobian of h
            case 3
                X = [-2*x(2), p(3)*p(4)*sin(x(3)-p(2)*p(3)),...
                    p(2)*p(4)*sin(x(3)-p(2)*p(3)), cos(x(3)-p(2)*p(3)), -1];
            % Event map
            case 4
                X = x;
            % Event map Jacobian
    ...
    case 6
        switch type
            ...
            % Parameter Jacobian of h
            case 3
                X = [-2*x(2), p(4)*p(3)*sin(x(3)-p(2)*p(3)), ...
                    p(4)*p(2)*sin(x(3)-p(2)*p(3)), cos(x(3)-p(2)*p(3)), 1];
            % Event map
            case 4
                X = x;
            % Event map Jacobian
