...
f = @(u) mpbvp(u(U_idx),u(T_idx),u(P_idx),orb0,sys,...
    po_delay_interp(u(U_idx),u(T_idx),u(P_idx),orb0.M,sys));
...
e_n = @(u) norm(mpbvp(u(U_idx),u(T_idx),u(P_idx),orb0,sys,...
    po_delay_interp(u(U_idx),u(T_idx),u(P_idx),orb0.M,sys))); % solution error
