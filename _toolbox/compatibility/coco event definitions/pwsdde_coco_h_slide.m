...
f = @(u) mpbvp_sl(u(U_idx),u(T_idx),u(P_idx),orb0,sys,bif_ind);
Jf = @(u) [mpbvp_sl_Ju(u(U_idx),u(T_idx),u(P_idx),orb0,sys,bif_ind) ...
    mpbvp_sl_Jp(u(U_idx),u(T_idx),u(P_idx),orb0,sys,bif_ind)];
