...
f = @(u) mpbvp_gr(u(U_idx),u(T_idx),u(P_idx),orb0,sys,bif_ind);
Jf = @(u) [mpbvp_gr_Ju(u(U_idx),u(T_idx),u(P_idx),orb0,sys,bif_ind) ...
    mpbvp_gr_Jp(u(U_idx),u(T_idx),u(P_idx),orb0,sys,bif_ind)];
