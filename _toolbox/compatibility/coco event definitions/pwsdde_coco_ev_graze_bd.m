...
for i = ev_ind
    ...
    gr_n = @(u) mpbvp_gr(u(U_idx),u(T_idx),u(P_idx),orb0,sys,i);
    Jgr_n = @(u) [mpbvp_gr_Ju(u(U_idx),u(T_idx),u(P_idx),orb0,sys,i) ...
        mpbvp_gr_Jp(u(U_idx),u(T_idx),u(P_idx),orb0,sys,i)];
